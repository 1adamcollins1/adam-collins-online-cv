<template>   
    <div 
        class="absolute inset-0 p-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2  w-full flex flex-col justify-between items-center translate-all duration-500"
        :class="[
    ...
    >
        <p 
            ...
            :class="pinTitleChildren ? 'lg:text-5xl md:text-4xl text-4xl' : 'lg:text-4xl md:text-3xl text-3xl cursor-pointer'"
        >
            Adam Collins
        </p>
        <div 
            class="rounded-3xl h-1 bg-[#22313f] translate-[width] duration-500"
