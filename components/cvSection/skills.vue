<template>  
    <div>
        ...
        <div class="w-full overflow-scroll flex-1 pb-4">
            ...
            <p>Docker, Figma, Postman, FileZilla, Siteground, Git CLI, Git Version Control, REST API's,  GitLab management, Jira, Fintech, Google Analytics, Firebase, Cloudflare</p>
        </div>
    </div>
</template>
